...
csi_error_t  csi_usb_hid_init(csp_usb_t *ptUsbBase,csi_usb_config_t ptUsbCfg)
{
	...
	csp_usb_set_iso_tx1(ptUsbBase,USB_ISO_DIS,USB_ISO_EP_1);
	csp_usb_set_iso_rx0(ptUsbBase,USB_ISO_DIS,USB_ISO_EP_1);
...
//	for(uint8_t i=0;i<ui_rx_length;i++)
//		my_printf("%d ",ep0_rx_buf[i]);	
//	my_printf("\r\n");
...
void csi_usb_setup_handler(csp_usb_t *ptUsbBase)
{
	...
	/* Format of setup Data (according to Table 9-2)
	 * 
	 * tUsbSetup.byBuf[0]: byRequestType
	 * tUsbSetup.byBuf[1]: bRequest
	 * tUsbSetup.byBuf[2][3]: wValue
	 * 							1: DEVICE
	 * 							2: CONFIGURATION
     *							3: STRING
	 *							4: INTERFACE
	 * 							5: ENDPOINT
	 * tUsbSetup.byBuf[4][5]: wIndex
	 * tUsbSetup.byBuf[6][7]: wLength
	 */
...
//	my_printf("\r\n");
	...
	{
		case 0x00:	//Host ->Device, standard, Recipient:Device
			...
			break;
		case 0x01: //Host ->Device, standard, Recipient:Interface
			switch(tUsbSetup.b.byRequest)
			{
			...
			break;
		case 0x02: //Host ->Device, standard, Recipient:Endpoint
			switch(tUsbSetup.b.byRequest)
			{
				case USB_CLR_FEATURE:
			...
			break;
		case 0x21: //Host ->Device, class特有, Recipient:Interface
			switch(tUsbSetup.b.byRequest)
			{
				case USB_SET_IDLE:
			...
			break;
		case 0x22:	//Host ->Device, class特有, Recipient:Endpoint
			switch(tUsbSetup.b.byRequest)
			{
	//		case USB_SET_CUR:
	...
	//			break;
			...
			break;
		case 0x80:	//Device -> Host, standard, Recipient:Device
			switch(tUsbSetup.b.byRequest)
			{
			case USB_GET_STATUS:
			...
			break;
		case 0x81:	//Device -> Host, standard, Recipient:Interface
			switch(tUsbSetup.b.byRequest)
			{
			case USB_GET_STATUS:
			...
			break;
		case 0x82: //Device -> Host, standard, Recipient:Endpoint
			switch(tUsbSetup.b.byRequest)
			{
				case USB_GET_STATUS:
			...
			break;
		case 0xA1://Device -> Host, class特有, Recipient:Interface
			switch(tUsbSetup.b.byRequest)
			{
				case USB_GET_REPORT:
	...
	//					break;
			...
			break;
		case 0xA2: //Device -> Host, class特有, Recipient:Endpoint
			switch(tUsbSetup.b.byRequest)
			{
	//			case USB_GET_CUR:
