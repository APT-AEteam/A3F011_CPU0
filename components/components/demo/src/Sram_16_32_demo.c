...
#define SRAMBLKCTRL_POS   (27)
#define SRAMBLKCTRL_MSK	  (0x01 << SRAMBLKCTRL_POS)
#define SRAM1FUNCCTRL_POS  (26)
...
{   SYSCON->OPTCR = (SYSCON->OPTCR & ~(SRAMBLKCTRL_MSK)) |  ( 0 << SRAMBLKCTRL_POS );  //测试版本0h和1h是反的  FPGA为0827版本
                                                                                       ...
                                                                                       /* SRAM 分区控制。SRAM0始终为DSRAM，SRAM1的功能受OPT1[24]位控制
																						...
																						1h:  SRAM0 16K。 地址范围0x20000000~0x20003FFF
																							  ...
																							  * 此模式要LD文件的SRAM设为16K
																					  */
	SYSCON->OPTCR = (SYSCON->OPTCR & ~(SRAM1FUNCCTRL_MSK)) | ( 0 << SRAM1FUNCCTRL_POS );
																					   /*SRAM1功能控制
																						0h：SRAM1作为DSRAM用
