...
csp_syscon_t 	*SYSCON  	= (csp_syscon_t *)(SYSCON_ADDR_BASE);
...
csp_qspi_t      *QSPI     	= (csp_qspi_t 	*)(QSPI_ADDR_BASE);
...
csp_bt_t  		*I2S0 	   	= (csp_bt_t 	*)(APB_I2S0_BASE) ;
csp_bt_t  		*I2S1 	   	= (csp_bt_t 	*)(APB_I2S1_BASE) ;
csp_crc_t 		*CRC      	= (csp_crc_t 	*)(AHB_CRC_BASE);
csp_rtc_t 		*RTC      	= (csp_rtc_t 	*)(APB_RTC_BASE);
csp_iwdt_t 		*IWDT		= (csp_iwdt_t 	*)(SYSCON_ADDR_BASE);