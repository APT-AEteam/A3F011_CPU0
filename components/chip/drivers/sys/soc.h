...
#define APB_EPT0_BASE   	(APB2_PERI_BASE + 0xE000)
...
//
#define QSPI_ADDR_BASE		0x60000000UL

#define HWDIV_ADDR_BASE		0x70000000UL

#define SYSCON_ADDR_BASE	0x80000000UL
...
#define	I2S0_INT      		(0x01ul<<64U)
#define	I2S1_INT      		(0x01ul<<65U)
