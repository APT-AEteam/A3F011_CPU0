...
/*
 * USB microphone input, support mono or dual channel options
 */
//#define  USB_LIB_MIC_ONE_CHANNEL_INPUT
 #define  USB_LIB_MIC_TWO_CHANNEL_INPUT

//#define  USB_AUDIO_SAMPLE_44K1
#define  USB_AUDIO_SAMPLE_48K                                   //工程原始配置
//#define  USB_AUDIO_SAMPLE_44K1_48K
